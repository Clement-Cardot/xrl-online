...
public class CustomRuntimeException extends Exception {
    ...
    private HttpStatusCode defineHttpCode(String message){
        switch(message){
            case USER_NOT_FOUND, TEAM_NOT_FOUND, PROJECT_NOT_FOUND, BUSINESS_LINE_NOT_FOUND:
                return HttpStatus.NOT_FOUND;
            case UNEXPECTED_EXCEPTION:
                return HttpStatus.I_AM_A_TEAPOT;
            case TEAM_NAME_ALREADY_EXISTS, USER_LOGIN_ALREADY_EXISTS, PROJECT_NAME_ALREADY_EXISTS, BUSINESS_LINE_NAME_ALREADY_EXISTS:
                return HttpStatus.CONFLICT;
            case DUPLICATE_MEMBERS, TEAM_NAME_NULL, USER_LOGIN_NULL, USER_FIRSTNAME_NULL, USER_LASTNAME_NULL, BUSINESS_LINE_DESCRIPTION_NULL, BUSINESS_LINE_NAME_NULL:
                return HttpStatus.BAD_REQUEST;
            case USER_LIST_EMPTY, TEAM_LIST_EMPTY, BUSINESS_LINE_LIST_EMPTY:
