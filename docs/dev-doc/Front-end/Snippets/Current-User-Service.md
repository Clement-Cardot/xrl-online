...
The current user service is used to manage data of the current user.<br>
It allow us to save the data to a local storage (like a cookie), but also to view the userData from any component as a observable.
